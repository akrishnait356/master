...
var RequestHandler = class {
  constructor(args) {
    ...
    this.info = __spreadProps2(__spreadValues2({}, args.info), {
      callFrame
    });
    this.isUsed = false;
  }
  ...
  run(args) {
    return __async3(this, null, function* () {
      ...
      const mockedResponse = yield executeResolver(__spreadProps2(__spreadValues2({}, resolverExtras), {
        request: args.request
      }));
...
function getAllRequestCookies(request) {
  ...
  const forwardedCookies = __spreadValues3(__spreadValues3({}, cookiesFromDocument), cookiesFromStore);
  for (const [name, value] of Object.entries(forwardedCookies)) {
    request.headers.append("cookie", source_default2.serialize(name, value));
  }
  return __spreadValues3(__spreadValues3({}, forwardedCookies), cookiesFromHeaders);
}
  ...
  if (from && typeof from === "object" || typeof from === "function") {
    for (let key of __getOwnPropNames4(from))
      if (!__hasOwnProp6.call(to, key) && key !== except)
        __defProp7(to, key, { get: () => from[key], enumerable: !(desc = __getOwnPropDesc4(from, key)) || desc.enumerable });
  }
  return to;
};
    ...
    switch (request.method) {
      ...
      case "POST": {
        ...
        if ((_a2 = request.headers.get("content-type")) == null ? void 0 : _a2.includes("multipart/form-data")) {
          ...
          const _b2 = responseJson, { operations, map } = _b2, files = __objRest2(_b2, ["operations", "map"]);
...
var __defNormalProp3 = (obj, key, value) => key in obj ? __defProp8(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
...
var __spreadProps3 = (a, b) => __defProps2(a, __getOwnPropDescs2(b));
...
var graphql2 = __spreadProps3(__spreadValues4({}, standardGraphQLHandlers), {
  /**
...
var getResponse = (request, handlers, resolutionContext) => __async9(void 0, null, function* () {
...
var __spreadProps4 = (a, b) => __defProps3(a, __getOwnPropDescs3(b));
function readResponseCookies(request, response) {
  store.add(__spreadProps4(__spreadValues5({}, request), { url: request.url.toString() }), response);
  store.persist();
}
...
var __spreadProps5 = (a, b) => __defProps4(a, __getOwnPropDescs4(b));
...
function normalizeResponseInit(init = {}) {
  ...
  return __spreadProps5(__spreadValues6({}, init), {
    headers,
    status,
    statusText
  });
...
@bundled-es-modules/cookie/index-esm.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-CXYWF3DS.js.map
